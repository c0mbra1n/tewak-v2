        ...
        function fetchMonitoringData() {
            fetch('../api/monitoring.php')
                ...
                .then(data => {
                    ...
                    if (data.length === 0) {
                        grid.innerHTML = '<div class="text-center" style="grid-column: 1/-1;">Belum ada data guru.</div>';
                        tbody.innerHTML = '<tr><td colspan="6" class="text-center">Belum ada data guru.</td></tr>';
                        return;
                    }
                ...
                .catch(error => {
                    ...
                    const grid = document.getElementById('monitoring-grid');
                    grid.innerHTML = `<div class="text-center" style="grid-column: 1/-1; color: red;">Error: ${error.message}</div>`;

                    const tbody = document.getElementById('monitoring-table-body');
                    tbody.innerHTML = `<tr><td colspan="6" class="text-center" style="color: red;">Error: ${error.message}</td></tr>`;
                });
        }
