...
// Fetch All Unique Subjects from Teachers
$stmt = $pdo->query("SELECT subjects FROM users WHERE role = 'guru' AND subjects IS NOT NULL");
$all_subjects_raw = $stmt->fetchAll(PDO::FETCH_COLUMN);
$all_subjects = [];
foreach ($all_subjects_raw as $raw) {
    $parts = explode(',', $raw);
...
<head>
    ...
    <title>Manajemen Jadwal - Tewak Apps</title>
                ...
                <div class="form-group">
                    ...
                    <?php if (!empty($all_subjects)): ?>
                        ...
                        <small style="display: block; color: #666; margin-top: 5px;">
                            *Diambil dari profil semua guru.
                        </small>
                    <?php else: ?>
                        ...
                        <small style="display: block; color: #dc3545; margin-top: 5px;">
                            Belum ada guru yang menginput mapel di profil mereka.
                        </small>
                    <?php endif; ?>
                </div>
